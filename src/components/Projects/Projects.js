          ...
          <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            ...
            <Col md={4} className="project-card">
              <ProjectCard
                ...
                isBlog={false}
                title="EduKids"
                description="EduKids is a mobile app that gives nursery students the ability to learn and improve their knowledge simply by using the app. The app is built with React Native, Javascript and Firebase. It has features which allows users to login, logout, and learn materials for alphabets, numbers, phrases, shapes, colors, as well as activities to improve knowledge."
            ...
            <Col md={4} className="project-card">
              <ProjectCard
                ...
                description="Aragi Hospital's website is full of useful content for anyone looking for a hospital. This website is developed with HTML and CSS. This website provide detailed information about their services, facilities, medical packages, and even career opportunities. Users can easily find their contact information and details about their international patients program."
            ...
            <Col md={4} className="project-card">
              <ProjectCard
                ...
                description="Welcome to my personal website! This website exists as a means for you to find out more about me, see some of my previous projects, and get in touch if you'd like to collaborate on something. You can also find my resume here and links to my social media profiles. It is developed using React and emailjs technologies. I hope you enjoy exploring the site!"
